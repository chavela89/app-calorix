...
const ruTranslations: Translation = {
  ...
  profile_visibility_description: "Управление тем, кто может видеть ваш профиль и активность",
  ...
  // Additional translations needed for the fixes
  duplicate: "Дублировать",
  add_to_favorites: "Добавить в избранное",
  item_duplicated: "Продукт дублирован",
  item_added_to_meal: "Продукт добавлен к приему пищи {meal}",
  added_to_favorites: "Добавлено в избранное",
  item_added_to_favorites: "Продукт добавлен в избранные",
  edit_food: "Редактировать продукт",
  edit_food_description: "Измените информацию о продукте",
  item_deleted: "Продукт удален",
  item_removed_from_meal: "Продукт удален из приема пищи {meal}",
  ...
  recipe_step_2: "Промойте и обсушите куриную грудку",
  recipe_step_3: "Смешайте оливковое масло, чеснок, сок лимона, розмарин, соль и перец",
  recipe_step_4: "Замаринуйте курицу в смеси на 15 минут",
  recipe_step_5: "Запекайте 20-25 минут до готовности",
  medium: "Средне",
  healthy: "Полезное",
  chicken: "Куриное",
  burned: "сожжено",
...
const enTranslations: Translation = {
  ...
  profile_visibility_description: "Control who can see your profile and activity",
  ...
  recipe_step_2: "Rinse and pat dry the chicken breast",
  recipe_step_3: "Mix olive oil, garlic, lemon juice, rosemary, salt and pepper",
  recipe_step_4: "Marinate the chicken in the mixture for 15 minutes",
  recipe_step_5: "Bake for 20-25 minutes until cooked through",
  medium: "Medium",
  healthy: "Healthy",
  chicken: "Chicken",
  burned: "burned"
